            ...
            <div class="animate form login_form">
                <section class="login_content">
                    <?php echo e(Form::open(['route' => 'password.email'])); ?>
                        ...
                        <div>
                            <button class="btn btn-default submit" id="reset" name="reset" type="submit"><?php echo e(__('views.auth.passwords.email.action')); ?></button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auth.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>