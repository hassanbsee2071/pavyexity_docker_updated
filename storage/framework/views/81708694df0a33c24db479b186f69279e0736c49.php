                ...
                <div class="">
                    <div class="ProductSummary">
                        <div class="ProductSummary-info select">
                            <select id="payment_method" class="Select-source w-100 col-md-7 col-xs-12 <?php if($errors->has('payment_method')): ?> parsley-error <?php endif; ?>" name="payment_method">
                        ...
                        <div class="ProductSummary-info select mt-2" style="margin-top:5px;">
                            ...
                            <input id="payment_amount" type="payment_amount" class="CheckoutInput Input Input--empty <?php if($errors->has('payment_amount')): ?> parsley-error <?php endif; ?>" name="payment_amount" placeholder="0.00$" value="<?php echo e($Transactions->transaction_amount); ?>" readonly />
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex-item width-12">
                                <div class="FormFieldGroup">
                                        ...
                                        <div class="FormFieldGroup-container">
                                            <div
                                                ...
                                                <div class="FormFieldInput"><span class="InputContainer"
                                                        data-max=""><input class="CheckoutInput Input Input--empty <?php if($errors->has('account_number')): ?> parsley-error <?php endif; ?>" name="account_number" placeholder="Enter bank account number"
                                            ...
                                            <div style="opacity: 0; height: 0px;"><span
                                                ...
                                                class="FormFieldGroup-child FormFieldGroup-child--width-12 FormFieldGroup-childLeft FormFieldGroup-childRight FormFieldGroup-childTop FormFieldGroup-childBottom">
                                                <div class="FormFieldInput"><span class="InputContainer"
                                                        data-max=""><input class="CheckoutInput Input Input--empty <?php if($errors->has('routing_number')): ?> parsley-error <?php endif; ?>" id="routing_number" onkeyup="routing(this)" type="number" name="routing_number" placeholder="Enter bank routing number"></span></div>
                                            </div>
                                            <div
                                                class="FormFieldGroup-child FormFieldGroup-child--width-12 FormFieldGroup-childLeft FormFieldGroup-childRight FormFieldGroup-childTop FormFieldGroup-childBottom">
                                    ...
                                    <div class="SubmitButton-TextContainer"><span
                                            ...
                                            aria-hidden="false">Pay US$<?php echo e($Transactions->transaction_amount); ?></span><span
...
<?php echo e(Html::script('https://cdnjs.cloudflare.com/ajax/libs/jquery.payment/3.0.0/jquery.payment.js')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auth.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/admin/payments/receivepayment.blade.php ENDPATH**/ ?>