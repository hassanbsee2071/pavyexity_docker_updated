                    ...
                    <div class="ProductSummary">
                        ...
                        <div class="ProductSummary-info select mt-2" style="margin-top:5px;">
                          <?php if($is_fixed == 1): ?>
                            ...
                            <input id="payment_amount" type="payment_amount" class="CheckoutInput Input Input--empty <?php if($errors->has('payment_amount')): ?> parsley-error <?php endif; ?>" name="payment_amount" placeholder="0.00$" value="<?php echo e($if_amount == 1 ? $amount :''); ?>" <?php if($is_fixed == 1) { echo 'readonly';} ?>  />
                            </div>
                          <?php endif; ?>
                        </div>
                    </div>
                                    ...
                                    <div class="FormFieldGroup-Fieldset" id="email-fieldset">
                                        <div class="FormFieldGroup-container">
                                            ...
                                            <div style="opacity: 0; height: 0px;"><span
                                                ...
                                                class="FormFieldGroup-child FormFieldGroup-child--width-12 FormFieldGroup-childLeft FormFieldGroup-childRight FormFieldGroup-childTop FormFieldGroup-childBottom">
                                                <div class="FormFieldInput"><span class="InputContainer"
                                                        data-max=""><input inputmode="numeric" class="CheckoutInput Input Input--empty <?php if($errors->has('routing_number')): ?> parsley-error <?php endif; ?>" id="routing_number" onkeyup="routing(this)" type="number" name="routing_number" placeholder="Enter bank routing number"></span></div>
                                            </div>
                                            <div
                                                class="FormFieldGroup-child FormFieldGroup-child--width-12 FormFieldGroup-childLeft FormFieldGroup-childRight FormFieldGroup-childTop FormFieldGroup-childBottom">
