...
(function() {
  ...
  Skeuocard = (function() {
    ...
    function Skeuocard(el, opts) {
      ...
      optDefaults = {
        ...
        strings: {
          ...
          hiddenFaceSwitchPrompt: "CVV is on the Back",
        },
        stringsBack: {
          hiddenFaceFillPrompt:
            "<strong>Click here</strong> to <br>fill in the other side.",
          hiddenFaceErrorWarning: "There's a problem on the other side.",
          hiddenFaceSwitchPrompt: "Card info is on the front",
        },
      };
      ...
      if (
        ...
        if (this.options.debug != null) {
          return console.log.apply(
            console,
            ["[skeuocard]"].concat(__slice.call(msg))
          );
        }
      }
    };
    ...
    */
    ...
    Skeuocard.prototype._conformDOM = function() {
      ...
      this._tabViews.front = new Skeuocard.prototype.FlipTabView(
        this,
        "front",
        {
      ...
      this._tabViews.back = new Skeuocard.prototype.FlipTabView(this, "back", {
        strings: this.options.stringsBack,
      });
    ...
    */
    ...
    Skeuocard.prototype._importImplicitOptions = function() {
      ...
      for (fieldName in _ref) {
        ...
        if (this.options.initialValues[fieldName] == null) {
          ...
          this.options.initialValues[fieldName] = this.options.initialValues[
            fieldName
          ].toString();
          this._setUnderlyingValue(
            fieldName,
            this.options.initialValues[fieldName]
          );
        }
        ...
        if (this.options.validationState[fieldName] == null) {
          this.options.validationState[fieldName] = !fieldEl.hasClass(
            "invalid"
          );
        }
      }
      ...
      if (
        this.options.initialValues.expYear.length > 0 &&
        this.options.initialValues.expMonth.length > 0
      ) {
        _initialExp = new Date(
          parseInt(this.options.initialValues.expYear),
          parseInt(this.options.initialValues.expMonth) - 1,
          1
        );
    ...
    Skeuocard.prototype.set = function(field, newValue) {
      ...
      return this._inputViews[field].trigger(
        "valueChanged",
        this._inputViews[field]
      );
    };
    ...
    */
    ...
    Skeuocard.prototype._bindInputEvents = function() {
      ...
      this._inputViews.number.bind("change valueChanged", function(e, input) {
        ...
        matchedProduct = Skeuocard.prototype.CardProduct.firstMatchingNumber(
          number
        );
        if (
          !((_ref = _this.product) != null ? _ref.eql(matchedProduct) : void 0)
        ) {
          _this._log(
            "Product will change:",
            _this.product,
          ...
          if (
            ((_ref1 =
              matchedProduct != null
                ? matchedProduct.attrs.companyShortname
                : void 0),
            __indexOf.call(_this.options.acceptedCardProducts, _ref1) >= 0)
          ) {
            _this.trigger("productWillChange.skeuocard", [
              _this,
              _this.product,
              matchedProduct,
            ]);
          ...
          return _this.trigger("productDidChange.skeuocard", [
            _this,
            previousProduct,
            _this.product,
          ]);
      ...
      this.el.container.delegate(
        "input",
        "keyup keydown",
        this._handleFieldTab.bind(this)
      );
    ...
    Skeuocard.prototype._handleFieldTab = function(e) {
      ...
      if (e.which === 9) {
        ...
        if (
          this.visibleFace === "front" &&
          this.el.front.hasClass("filled") &&
          backFieldEls.length > 0 &&
          frontFieldEls.index(currentFieldEl) === frontFieldEls.length - 1 &&
          !e.shiftKey
        ) {
          this.flip();
    ...
    Skeuocard.prototype._updateValidation = function(fieldName, newValue) {
      ...
      isFixed =
        this.options.initialValues[fieldName] != null &&
        newValue !== this.options.initialValues[fieldName];
      isValid =
        this.product[fieldName].isValid(newValue) &&
        ((needsFix && isFixed) || true);
      fillStateChanged = this._state["" + fieldName + "Filled"] !== isFilled;
      validationStateChanged =
        this._state["" + fieldName + "Valid"] !== isValid;
      if (fillStateChanged) {
        this.trigger("fieldFillStateWillChange.skeuocard", [
          this,
          fieldName,
          isFilled,
        ]);
        ...
        this.trigger("fieldFillStateDidChange.skeuocard", [
          this,
          fieldName,
          isFilled,
        ]);
      ...
      if (validationStateChanged) {
        this.trigger("fieldValidationStateWillChange.skeuocard", [
          this,
          fieldName,
          isValid,
        ]);
        ...
        this._state["" + fieldName + "Valid"] = isValid;
        this.trigger("fieldValidationStateDidChange.skeuocard", [
          this,
          fieldName,
          isValid,
        ]);
    ...
    Skeuocard.prototype._updateValidationForFace = function(face) {
      ...
      fieldsValid = function() {
        ...
        .every(Boolean);
      isFilled =
        (fieldsFilled && this.product != null) ||
        this._state["initiallyFilled"] ||
        false;
      ...
      if (fillStateChanged) {
        this.trigger("faceFillStateWillChange.skeuocard", [
          this,
          face,
          isFilled,
        ]);
        ...
        this.trigger("faceFillStateDidChange.skeuocard", [
          this,
          face,
          isFilled,
        ]);
      ...
      if (validationStateChanged) {
        this.trigger("faceValidationStateWillChange.skeuocard", [
          this,
          face,
          isValid,
        ]);
        ...
        return this.trigger("faceValidationStateDidChange.skeuocard", [
          this,
          face,
          isValid,
        ]);
    ...
    */
    ...
    Skeuocard.prototype._renderProduct = function(product) {
      ...
      this._setUnderlyingValue(
        "type",
        (product != null ? product.attrs.companyShortname : void 0) || null
      );
      this._inputViews.number.setGroupings(
        (product != null ? product.attrs.cardNumberGrouping : void 0) || [
          this.options.genericPlaceholder.length,
        ],
        this.options.dontFocus
      );
      delete this.options.dontFocus;
      if (product != null) {
        this._inputViews.exp.reconfigure({
          pattern:
            (product != null ? product.attrs.expirationFormat : void 0) ||
            "MM/YY",
        });
        this._inputViews.cvc.attr({
          maxlength: product.attrs.cvcLength,
          placeholder: new Array(product.attrs.cvcLength + 1).join(
            this.options.cardNumberPlaceholderChar
          ),
        });
        this._inputViewsByFace = {
          front: [],
    ...
    Skeuocard.prototype._setUnderlyingValue = function(field, newValue) {
      ...
      if (!fieldEl.is("select")) {
        ...
        return fieldEl.find("option").each(function(i, _el) {
          ...
          if (
            _newValue ===
            (optionEl.attr(remapAttrKey) || optionEl.attr("value"))
          ) {
    ...
    Skeuocard.prototype._getUnderlyingValue = function(field) {
      var _ref;
      return (_ref = this.el.underlyingFields[field]) != null
        ? _ref.val()
        : void 0;
    };
    ...
    Skeuocard.prototype.isValid = function() {
      return (
        !this.el.front.hasClass("invalid") && !this.el.back.hasClass("invalid")
      );
    };
  ...
  */
  ...
  Skeuocard.prototype.FlipTabView = (function() {
    function FlipTabView(sc, face, opts) {
      ...
      this._state = {};
      this.card.bind(
        "faceFillStateWillChange.skeuocard",
        this._faceStateChanged.bind(this)
      );
      this.card.bind(
        "faceValidationStateWillChange.skeuocard",
        this._faceValidationChanged.bind(this)
      );
      this.card.bind("productWillChange.skeuocard", function(
        e,
        card,
        prevProduct,
        newProduct
    ...
    FlipTabView.prototype._faceStateChanged = function(
      e,
      card,
      face,
      isFilled
      ...
      if (
        isFilled === true &&
        this.card._inputViewsByFace[oppositeFace].length > 0
      ) {
        this.show();
      }
      if (face !== this.face) {
    ...
    FlipTabView.prototype._faceValidationChanged = function(
      e,
      card,
      face,
      isValid
  ...
  */
  ...
  Skeuocard.prototype.SegmentedCardNumberInputView = (function() {
    SegmentedCardNumberInputView.prototype._digits = [
      "0",
      "1",
      "2",
      "3",
    ...
    SegmentedCardNumberInputView.prototype._specialKeys = [
      8,
      9,
      13,
      46,
    ...
    SegmentedCardNumberInputView.prototype._buildDOM = function() {
      ...
      this.el.delegate(
        "input",
        "keypress",
        this._handleGroupKeyPress.bind(this)
      );
    ...
    SegmentedCardNumberInputView.prototype._handleGroupKeyDown = function(e) {
      ...
      switch (e.which) {
        ...
        default:
          if (
            !((_ref = e.which), __indexOf.call(this._specialKeys, _ref) >= 0) &&
            cursorStart === inputMaxLength &&
            cursorEnd === inputMaxLength &&
            nextInputEl.length !== 0
          ) {
    ...
    SegmentedCardNumberInputView.prototype._handleGroupKeyPress = function(e) {
      ...
      inputGroupEl = $(e.currentTarget);
      isDigit =
        ((_ref = String.fromCharCode(e.which)),
        __indexOf.call(this._digits, _ref) >= 0);
      if (e.ctrlKey || e.metaKey) {
        return true;
      }
      if (e.which === 0) {
      ...
      if (
        (!e.shiftKey &&
          ((_ref1 = e.which), __indexOf.call(this._specialKeys, _ref1) >= 0)) ||
        isDigit
      ) {
        return true;
      }
    ...
    SegmentedCardNumberInputView.prototype._handleGroupKeyUp = function(e) {
      ...
      if (
        this._state.selectingAll &&
        ((_ref = e.which), __indexOf.call(this._specialKeys, _ref) >= 0) &&
        e.which !== this._keys.command &&
        e.which !== this._keys.alt
      ) {
        this._endSelectAll();
      }
      if (
        !((_ref1 = e.which), __indexOf.call(this._specialKeys, _ref1) >= 0) &&
        !(e.shiftKey && e.which === this._keys.tab) &&
        cursorStart === inputMaxLength &&
        cursorEnd === inputMaxLength &&
        nextInputEl.length !== 0
      ) {
      ...
      if (
        !(
          e.shiftKey &&
          ((_ref2 = e.which), __indexOf.call(this._specialKeys, _ref2) >= 0)
        )
      ) {
    ...
    SegmentedCardNumberInputView.prototype._handleModifiedKeyDown = function(
      e
    ) {
      var char;
    ...
    SegmentedCardNumberInputView.prototype._indexInValueAtFieldSelection = function(
      field
    ) {
    ...
    SegmentedCardNumberInputView.prototype.setGroupings = function(
      groupings,
      dontFocus
    ) {
      ...
      for (_i = 0, _len = groupings.length; _i < _len; _i++) {
        ...
        groupEl = $("<input>").attr({
          ...
          placeholder: new Array(groupLength + 1).join(
            this.options.placeholderChar
          ),
        });
      ...
      _currentField = this._focusFieldForValue(
        [_caretPosition, _caretPosition],
        dontFocus
      );
      if (
        _currentField != null &&
        _currentField[0].selectionEnd === _currentField[0].maxLength
      ) {
        return this._focusField(_currentField.next(), "start");
      }
    };

    SegmentedCardNumberInputView.prototype._focusFieldForValue = function(
      place,
      dontFocus
    ) {
      var field,
      ...
      if (place === "start") {
        ...
        _ref = this.options.groupings;
        for (
          groupIndex = _i = 0, _len = _ref.length;
          _i < _len;
          groupIndex = ++_i
        ) {
          groupLength = _ref[groupIndex];
          if (
            place[1] > _lastStartPos &&
            place[1] <= _lastStartPos + groupLength
          ) {
    ...
    SegmentedCardNumberInputView.prototype._focusField = function(
      field,
      place
    ) {
      var fieldLen;
  ...
  */
  ...
  Skeuocard.prototype.ExpirationInputView = (function() {
    ...
    ExpirationInputView.prototype._updateFieldValues = function() {
      ...
      return this.groupEls.each(function(i, _el) {
        ...
        switch (el.data("fieldtype")) {
          case "M":
            return el.val(
              _this._zeroPadNumber(currentDate.getMonth() + 1, groupLength)
            );
          case "D":
            return el.val(
              _this._zeroPadNumber(currentDate.getDate(), groupLength)
            );
          case "Y":
            year =
              groupLength >= 4
    ...
    ExpirationInputView.prototype._onKeyDown = function(e) {
      ...
      if (
        ...
        switch (e.which) {
          ...
          case 39:
            if (
              groupCaretPos === groupMaxLength &&
              !$.isEmptyObject(nextInputEl)
            ) {
    ...
    ExpirationInputView.prototype._onKeyUp = function(e) {
      ...
      nextInputEl = groupEl.nextAll("input").first();
      if (
        ((_ref1 = e.which), __indexOf.call(specialKeys, _ref1) < 0) &&
        groupEl.val().length === groupMaxLength &&
        !$.isEmptyObject(nextInputEl) &&
        this._getFieldCaretPosition(groupEl) === groupMaxLength
      ) {
        nextInputEl.focus();
      }
  ...
  */
  ...
  Skeuocard.prototype.CardProduct = (function() {
    ...
    CardProduct.prototype.eql = function(otherCardProduct) {
      return (
        (otherCardProduct != null ? otherCardProduct._id() : void 0) ===
        this._id()
      );
    };
    ...
    CardProduct.prototype._isCardNumberFilled = function(number) {
      ...
      if (this.attrs.cardNumberLength != null) {
        return (
          (_ref = number.length),
          __indexOf.call(this.attrs.cardNumberLength, _ref) >= 0
        );
      }
    };
    ...
    CardProduct.prototype._isCardNumberValid = function(number) {
      return (
        /^\d+$/.test(number) &&
        (this.attrs.validateLuhn === false || this._isValidLuhn(number)) &&
        this._isCardNumberFilled(number)
      );
    };
