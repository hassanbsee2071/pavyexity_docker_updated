...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 card" style="padding-top: 12px;">
        ...
        {{ Form::open(['route'=>['admin.company.invoice.save2'],'method' => 'post','class'=>'form-horizontal form-label-left', 'name' => "frminvoice"]) }}
        @if (count($errors) > 0)
        ...
        <div class="form-group">
            ...
            <div class=" control-label col-md-5 col-sm-6 col-xs-12">
                <a href="/admin/company/invoice/add">Send to someone who is user</a>
            </div>
        </div>
